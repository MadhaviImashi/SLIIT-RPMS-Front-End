import "./RequestCoSupervisor.css";
...
const RequestCoSuperVisor = () => {
  ...
  useEffect(() => {
    ...
    setIsError(false);
    fetch(
      "http://localhost:4000/api/acedemicStaff/getAllCoSupervisorRequests",
      {
        method: "GET",
        headers: {
    ...
    <div className="request-supervisor-bg-color vh-100">
      ...
      <div className="container">
        <div className="fs-3 pt-3 d-flex align-items-center ">
          ...
          <span className="ms-3">Request Co-Supervisor</span>
        </div>
        ...
        <div className="row px-3 pt-3">
          ...
          <div className="col-2">Coupervisor Name</div>
            ...
            return groupID === e.groupId ? (
              <div className="request-item" key={i}>
                <div className="row">
                  ...
                  <div className="col-2">{e.coSupervisorId.name}</div>
